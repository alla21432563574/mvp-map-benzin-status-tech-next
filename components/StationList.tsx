      ...
      {smartPickLoading ? (
        ...
        <section className="smart-pick-card mb-4 overflow-hidden rounded-[24px] border border-emerald-400/70 bg-gradient-to-br from-white via-emerald-50/80 to-lime/20 p-4 shadow-[0_12px_35px_rgba(31,107,69,.16)] dark:from-[#19241e] dark:via-[#173426] dark:to-[#1c442d]">
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
            ...
            <span className="rounded-xl bg-white/75 p-2.5 dark:bg-white/[.06]"><b className="block text-sm text-emerald-700 dark:text-emerald-300">● {smartPick.item.confidence}%</b><small className="text-ink/45 dark:text-white/45">уверенность</small></span>
            ...
            <span className="col-span-2 rounded-xl bg-white/75 p-2.5 dark:bg-white/[.06]"><b className="block text-sm">🚗 {queueLabel(smartPick.item.station)}</b><small className="text-ink/45 dark:text-white/45">ситуация на АЗС</small></span>
          </div>
